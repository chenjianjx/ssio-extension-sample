...
public class MyBeanFactory {
    ...
    public static MyBean allEmpty() {
        return new MyBean();
    }

    public static MyBean bigValues() {
        ...
        bean.setEnumeration(MyEnum.ENUM_VALUE_A);

        return bean;
    }


    public static MyBean normalValues() {
        MyBean bean = new MyBean();
    ...
    private static Date parseDate(String ddd) {
        try {
            return DateUtils.parseDate(ddd, "yyyy-MM-dd'T'HH:mm:ss");
